    ...
    <>
      ...
      <footer style={{ background: '#2185ff', color: 'white', padding: '60px 0 20px 0', marginTop: '60px' }}>
          ...
          <div style={{ flex: '1', minWidth: '300px' }}>
            ...
            <div style={{ display: 'flex', gap: '15px' }}>
              <a href="https://www.instagram.com/smpn3cibungbulang_official" target="_blank" rel="noopener noreferrer">
                <img src="/images/social/ig.svg" alt="Instagram" style={{ width: '40px', height: '40px', background: 'white', borderRadius: '8px', padding: '2px' }} />
              </a>
              <a href="https://www.tiktok.com/@smpn3cibungbulang_" target="_blank" rel="noopener noreferrer">
                <img src="/images/social/tiktok.svg" alt="TikTok" style={{ width: '40px', height: '40px', background: 'white', borderRadius: '8px', padding: '5px' }} />
              </a>
              <a href="https://youtube.com/@smpn3cibungbulang" target="_blank" rel="noopener noreferrer">
                <img src="/images/social/yt.svg" alt="YouTube" style={{ width: '40px', height: '40px', background: 'white', borderRadius: '8px', padding: '5px' }} />
              </a>
              <a href="https://www.facebook.com/smpn3cibungbulang" target="_blank" rel="noopener noreferrer">
                <img src="/images/social/fb.svg" alt="Facebook" style={{ width: '40px', height: '40px', background: 'white', borderRadius: '8px', padding: '2px' }} />
              </a>
            </div>
          </div>
        ...
        <div className="container" style={{ borderTop: '1px solid rgba(255,255,255,0.2)', paddingTop: '20px', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.9rem' }}>
          <p>&copy; smpn3-cibungbulang.sch.id. All Right Reserved.</p>
