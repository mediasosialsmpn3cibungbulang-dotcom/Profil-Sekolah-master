...
export async function PUT(request, { params }) {
  ...
  try {
    ...
    const data = { name, subject, photoUrl, description, education, experience, additionalRole, instagram: instagram || null, tiktok: tiktok || null, email: email || null, youtube: youtube || null };
